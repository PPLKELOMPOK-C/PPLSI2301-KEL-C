  ...
  <div class="content">
    <div class="status-card">
      <div class="status-icon pending">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
          <circle cx="12" cy="12" r="9" stroke="#f0a500" stroke-width="1.8"/>
          <path d="M12 7v5l3 3" stroke="#f0a500" stroke-width="1.8" stroke-linecap="round"/>
        </svg>
      </div>
      <div>
        <div class="status-label">Status Pengajuan</div>
        <div class="status-value">
          <span class="status-dot"></span>{{ $statusPengajuan }}
        </div>
      </div>
    </div>
    ...
    <div class="menu-grid">
      <div class="menu-card">
        <div class="menu-icon blue">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            <rect x="3" y="3" width="8" height="8" rx="1.5" fill="#378add"/>
            <rect x="13" y="3" width="8" height="8" rx="1.5" fill="#85b7eb"/>
            <rect x="3" y="13" width="8" height="8" rx="1.5" fill="#85b7eb"/>
            <rect x="13" y="13" width="8" height="8" rx="1.5" fill="#b5d4f4"/>
          </svg>
        </div>
        <div class="menu-title">Unit Tersedia</div>
        <div class="menu-desc">Lihat unit yang masih kosong</div>
        <a href="{{ route('calon.unit.index') }}" class="menu-btn blue">Lihat Unit</a>
      </div>

      <div class="menu-card">
        <div class="menu-icon green">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            <path d="M12 5v14M5 12h14" stroke="#3b7c1a" stroke-width="2" stroke-linecap="round"/>
          </svg>
        </div>
        <div class="menu-title">Ajukan Sewa</div>
        <div class="menu-desc">Isi form pengajuan sewa</div>
        <a href="{{ route('calon.pengajuan.create') }}" class="menu-btn green">Ajukan</a>
      </div>
      ...
      <div class="menu-card">
        ...
        <a href="{{ route('calon.pengajuan.tracking') }}" class="menu-btn amber">Lihat Status</a>
      </div>
    </div>
    ...
    <div class="info-strip">
      ...
      <button class="info-strip-action" type="button">Hubungi</button>
    </div>
